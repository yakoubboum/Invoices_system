    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    @can('قائمة الفواتير')
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'home/invoices')) }}">قائمة الفواتير</a></li>
                    @endcan

                    <li><a class="slide-item" href="{{ url('/' . ($page = 'home/paidinvoices')) }}">الفواتير
                            المدفوعة</a>
                    </li>

                    <li><a class="slide-item" href="{{ url('/' . ($page = 'home/Unpaid_invoices')) }}">الفواتير الغير
                            مدفوعة</a></li>

                    <li><a class="slide-item" href="{{ url('/' . ($page = 'home/partial_invoices')) }}">الفواتير
                            المدفوعة
                            جزئيا</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'home/archive_invoices')) }}">ارشيف
                            الفواتير</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'home/reports')) }}">تقارير الفواتير </a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'home/customersreports')) }}">تقارير العملاء</a>
                    </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'home/users')) }}">قائمة المستخدمين</a>
                    </li>

                    @can('عرض صلاحية')
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'home/roles')) }}">صلاحيات المستخدمين</a>
                        </li>
                    @endcan
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'home/sections')) }}">الاقسام</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'home/products')) }}">المنتجات</a></li>
